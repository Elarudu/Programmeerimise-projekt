...
def main():
    ...
    while running:
        ...
        # puhasta ekraan taustavärviga
        ekraan.fill(tiles[0])

        # --- Joonista kaart ---
        for y, row in enumerate(map_andmed):
            for x, tile in enumerate(row):
                val = tiles.get(tile, tiles[0])  # turvaline lookup, fallback taustale
                if isinstance(val, tuple):  # kui väärtus on värv
                    pygame.draw.rect(
                        ekraan,
                        val,
                        (x * ruudu_suurus, y * ruudu_suurus, ruudu_suurus, ruudu_suurus)
                    )
                elif val is not None:  # kui väärtus on pilt
...
if __name__ == "__main__":
    try:
        ...
        pygame.quit()
# ...existing code...
# filepath: c:\Users\miocristopher\Desktop\Uus kaust (2)\Programmeerimise-projekt\mang.py
# ...existing code...
import pygame
